...
It is important to note that the results from CodelistGenerator will be specific to a particular version of the OMOP CDM. We can see the version of the vocabulary being used like so
```{r, eval=FALSE}
