...
```{r, eval=FALSE }
dementiaCodes1<-getCandidateCodes(keywords="dementia",
                    domains="Condition",
...
```{r,  eval=FALSE }
icdMappings<-showMappings(candidateCodelist=dementiaCodes4,
...
```{r,  eval=FALSE }
readMappings<-showMappings(candidateCodelist=dementiaCodes4,
